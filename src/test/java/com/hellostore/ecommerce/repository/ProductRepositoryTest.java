...
class ProductRepositoryTest {
    ...
    void createProduct() {
        ...
        Product product = new Product(category1,"반팔 티셔츠", 10000, 12000, 10, PointType.DEFAULT, null, ShippingFeeType.DEFAULT, null, true, false, true, "바디라인에 달라붙지 않아 시원하게 입기 좋은 데일리 반팔 티셔츠",  null, null, null, ProductShowType.SHOW);
        Long product1 = productRepository.createProduct(product);

        ProductOption productOption1 = new ProductOption(product, "color", "black", "Y");
        ProductOption productOption2 = new ProductOption(product, "color", "white", "Y");
        ProductOption productOption3 = new ProductOption(product, "color", "blue", "Y");
        ProductOption productOption4 = new ProductOption(product, "size", "large", "Y");
        ProductOption productOption5 = new ProductOption(product, "size", "medium", "Y");
        ProductOption productOption6 = new ProductOption(product, "size", "small", "Y");
